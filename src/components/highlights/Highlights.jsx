  ...
  return (
    <section className="pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap bg-gray-800">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                For Farmers is it time to sell? For Buyers is it time to buy? Check out our market highlights to see what the experts are saying.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="-mx-4 flex flex-wrap">
          <ServiceCard
            title="Beans (Yellow-Green)"
            market="Nakuru-Wakulima"
            County="Nakuru"
            retailPrice="Ksh 100"
            wholesalePrice ="Ksh 90"
            details="."
            icon={
              <svg
                width="36"
...
const ServiceCard = ({ icon, title, details, market, retailPrice, wholesalePrice }) => {
    return (
      <>
        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
          <div className="mb-9 rounded-[20px] bg-white p-10 shadow-2 hover:shadow-lg dark:bg-dark-2 md:px-7 xl:px-10">
            ...
            <h4 className="mb-[14px] text-2xl font-semibold text-dark dark:text-gray-900">
              {title}
            </h4>
              <p className="text-body-color dark:text-dark-6">{market}</p>
              <p className="text-body-color dark:text-dark-6">{retailPrice}</p>
              <p className="text-body-color dark:text-dark-6">{wholesalePrice}</p>
