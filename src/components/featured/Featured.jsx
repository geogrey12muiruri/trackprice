// create a Featured component below
...
const Featured = () => {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Empowering the African Agricultural Sector: Real-time Prices, Insights, and Tools for Everyone</h2>
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">Farmers, traders, consumers, policymakers, researchers, and investors - gain the crucial edge with Kenyas most comprehensive commodity price platform.</p>
      </div>
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Real-time Prices</h3>
              <p className="text-gray-500 dark:text-gray-400">Stay ahead of the market with live updates from numerous Kenyan markets for all key agricultural commodities.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Granular Search</h3>
              <p className="text-gray-500 dark:text-gray-400">Filter by market, commodity, and date to find the exact information you need, empowering informed decisions.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Price Trend Tracking</h3>
              <p className="text-gray-500 dark:text-gray-400">Visualize historical and projected price movements through intuitive charts and graphs, anticipating market shifts and maximizing profits.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Personalized Price Alerts</h3>
              <p className="text-gray-500 dark:text-gray-400">Set up notifications for specific commodities and be instantly informed when prices hit your target levels.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Invaluable Market Insights</h3>
              <p className="text-gray-500 dark:text-gray-400">Access expert analysis and commentary, understanding the factors driving price changes and optimizing your strategies.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Data-Driven Decision Making</h3>
              <p className="text-gray-500 dark:text-gray-400">Utilize advanced charts, graphs, and downloadable reports to unlock powerful insights and gain a competitive advantage</p>
          </div>
      </div>
  </div>
</section>
